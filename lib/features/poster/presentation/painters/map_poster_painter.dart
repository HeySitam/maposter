...
class MapPosterPainter extends CustomPainter {
  ...
  // Flutter canvas has y=0 at top → Flutter y = size.height * (1 - transAxes_y)
  //
  //   transAxes  →  Flutter yFromTop factor
  //   0.14       →  0.86   (city name)
  //   0.125      →  0.875  (divider line)
  //   0.10       →  0.90   (country)
  //   0.07       →  0.93   (coordinates)
  //   0.02       →  0.98   (attribution)
  ...
  bool _isLatinScript(String text) =>
      RegExp(r'^[\u0000-\u024F\s]+$').hasMatch(text);
}
