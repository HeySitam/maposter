...
/// Web Mercator projection helpers: project lat/lon to metres or screen
/// offsets, compute bounding boxes, and the aspect-ratio over-fetch radius.
abstract final class Mercator {
  ...
  static (double x, double y) project(LatLon latLon, LatLon origin) {
    ...
    final y =
        _earthRadius * log(tan(pi / 4 + lat * pi / 360)) -
  ...
  static List<Offset> projectToScreen(
    ...
    final scale =
        max(canvasSize.width / mercWidth, canvasSize.height / mercHeight) *
        zoomFactor;
